...
class UserMeta(WordPressModel):
    ...
    user = models.ForeignKey(User, related_name="meta", db_column='user_id', on_delete='cascade')
...
#    category_id = models.IntegerField(default=0, db_column='link_category')
    ...
    owner = models.ForeignKey(User, related_name='links', db_column='link_owner', on_delete='cascade')
...
class TermTaxonomyRelationship(WordPressModel):
    ...
    object = models.ForeignKey('Post', on_delete='cascade')
    term_taxonomy = models.ForeignKey('Taxonomy', related_name='relationships', db_column='term_taxonomy_id', on_delete='cascade')
...
class Post(WordPressModel):
    ...
    author = models.ForeignKey(User, related_name='posts', db_column='post_author', on_delete='cascade')
...
class PostMeta(WordPressModel):
    ...
    post = models.ForeignKey(Post, related_name='meta', db_column='post_id', on_delete='cascade')
    key = models.CharField(max_length=255, db_column='meta_key')
    value = models.TextField(db_column='meta_value')
...
class Comment(WordPressModel):
    ...
    post = models.ForeignKey(Post, related_name="comments", db_column="comment_post_id", on_delete='cascade')
...
class Taxonomy(WordPressModel):
    ...
    term = models.ForeignKey(Term, related_name='taxonomies', blank=True, null=True, on_delete='cascade')
